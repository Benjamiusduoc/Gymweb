package com.gym.suscripciones.controller;

import com.gym.suscripciones.model.Plan;
import com.gym.suscripciones.model.SuscripcionUsuario;
import com.gym.suscripciones.service.SuscripcionService;
...
public class SuscripcionController {
    ...
    @PostMapping("/planes")
    public ResponseEntity<Plan> crearPlan(@Valid @RequestBody Plan plan) {
